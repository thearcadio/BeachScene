...
namespace ErosionBrushPlugin 
{
	...
	public class Matrix : Matrix2<float>
	{
		...
		#region Blur
			...
			public void Blur (System.Func<float,float,float,float> blurFn=null, float intensity=0.666f, bool additive=false, bool horizontal=true, bool vertical=true, Matrix reference=null)
			{
		...
		/*public float GetOnWorldRect (Vector2 worldPos, Rect worldRect)
			...
			{
				if (dst.rect != src.rect || dst.rect != mask.rect) Debug.LogError("Matrix Mask: maps have different sizes");
